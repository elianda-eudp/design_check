...
#    print(normal_list)
    data = {Head1:{Head2_list[0]:normal_list[0], 
                    Head2_list[1]:table.table(document,34), 
                    ...
                    Head2_list[3]:{Head3_list[5]:'',
                                  ...
                                  Head3_list[8]:'',
                                  Head3_list[9]:''},
                    Head2_list[4]:{Head3_list[10]+normal_list[13]:table.table(document,35)},
                                
                    Head2_list[5]:{Head3_list[11]:normal_list[14]+normal_list[15]},
                    Head2_list[6]:{Head3_list[12]:normal_list[16]+normal_list[17]+normal_list[18],
                                  Head3_list[13]:normal_list[19],
                                  Head3_list[14]:normal_list[20]},
                    Head2_list[7]:normal_list[21]+normal_list[22]+normal_list[23]+normal_list[24]+
                                  normal_list[25]+normal_list[26]
                
                }}
                
    print(data)
    
    with open('程序名称(jhye_profit).json','w+') as f:
