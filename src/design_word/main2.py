...
#    print(normal_list)
    data = {Head1:{Head2_list[0]:normal_list[0], 
                Head2_list[1]:table.table(document,9), 
                ...
                Head2_list[3]:{Head3_list[5]:'',
                              ...
                              Head3_list[7]:table.table(document,10),
                              Head3_list[8]:table.table(document,11),
                              Head3_list[9]:table.table(document,12)},
                Head2_list[4]:{Head3_list[10]+normal_list[13]:table.table(document,13),
                              Head3_list[11]+normal_list[14]:table.table(document,14),
                              Head3_list[12]+normal_list[15]:table.table(document,15)},
    ...
    with open('程序名称(jhye_profit_file_out).json','w+') as f:
