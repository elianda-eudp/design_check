...
#                print(normal)
    ...
    data = {Head1:{Head2_list[0]:normal_list[0], 
                Head2_list[1]:table.table(document,0), 
                Head2_list[2]:{Head3_list[0]:'',
                               Head3_list[1]: normal_list[2],
                               Head3_list[2]:table.table(document,1),
                               Head3_list[3]:table.table(document,2),
                               Head3_list[4]:table.table(document,3)},        
                Head2_list[3]:{Head3_list[5]:'',
                              Head3_list[6]:normal_list[7],
                              Head3_list[7]:table.table(document,4),
                              Head3_list[8]:table.table(document,5),
                              Head3_list[9]:table.table(document,6)},
                Head2_list[4]:{Head3_list[10]+normal_list[13]:table.table(document,7),
                              Head3_list[11]+normal_list[15]:table.table(document,8)},
    ...
    with open('程序名称(sql_to_csv).json','w+') as f:
